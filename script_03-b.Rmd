...
We'd want the workloads for each course during the first three weeks. Ideally,
we'd have data for each individual member of the course and why they decided to 
keep or drop a class.

An infinite preceptor table would give us all the possible data that we could ever want. An ideal
preceptor table would limit it down 
...
We'd to know the difference between expected hours worked during the course
and actual hours. We could use this info to run a regression discontinuity design.
